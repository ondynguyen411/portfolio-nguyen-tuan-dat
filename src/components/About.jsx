...
// =================IMPORTANT=================
// 1. Place your "about me" image inside the 'src' folder.
// 2. Uncomment the line below and change 'about-me.png' to your actual filename if different.
// import aboutMeImg from '../about-me.png'; 

// --- PLACEHOLDER IMAGE (DELETE THIS LINE AFTER IMPORTING YOUR IMAGE ABOVE) ---
const aboutMeImg = "https://placehold.co/300x600/0f172a/00DFD8?text=About+Me+Image&font=roboto";
// ---------------------------------------------------------------------------
    ...
    return (
        <section id="about" className="py-20 px-4">
            <div className="max-w-6xl mx-auto">
                ...
                {/* --- BOTTOM: Large Rectangle Container (The 2/8 Split Layout) --- */}
                <div className="flex flex-col md:flex-row bg-slate-800/50 border border-slate-700 rounded-3xl overflow-hidden backdrop-blur-sm shadow-[0_0_30px_rgba(0,223,216,0.1)]">
                    ...
                    {/* === LEFT SIDE (approx 2/10 width): Image with Vibe Effects === */}
                    <div className="w-full md:w-1/4 relative flex items-end justify-center pt-8 bg-slate-900/50 md:border-r border-b md:border-b-0 border-cyan-500/30 overflow-hidden">
                        {/* Subtle background glow blob behind image */}
                    ...
                    {/* === RIGHT SIDE (approx 8/10 width): Content Area === */}
                    <div className="w-full md:w-3/4 p-8 md:p-10 flex flex-col gap-10">
                        
                        {/* -- Content Above: Intro Paragraph -- */}
                        <div>
                            <h4 className="text-2xl font-bold text-white mb-4">Hello! I am Nguyễn Tuấn Đạt.</h4>
                            <p className="text-lg text-slate-300 leading-relaxed">
                                As a <strong className="text-white font-semibold">final-year MIS student</strong>, I have cultivated a deep interest in how information systems can transform business operations. My academic journey and hands-on projects have prepared me to analyze complex business needs, design effective workflows, and ensure the highest quality in software development.
                            </p>
                        </div>

                        {/* (Đã xóa đường kẻ ngang Divider Line theo ý bạn để giao diện liền mạch hơn) */}

                        {/* -- Content Below: Split Columns (School Logo + Info) -- */}
                        <div className="flex flex-col md:flex-row gap-8 items-center md:items-center mt-2">
                            
                            {/* Column 1 (Small width): School Logo Area - Đã Căn Giữa Tuyệt Đối */}
                            ...
                            {/* Column 2 (Larger width): Detailed Info List */}
                            <div className="w-full md:w-3/4 grid gap-6">
                                {aboutDetails.map((item, index) => (
                                    <div key={index} className="flex gap-5 items-center group">
                                        ...
                                        {/* Text Content - Đã đổi style để nội dung chính nổi bật hơn */}
                                        <div>
